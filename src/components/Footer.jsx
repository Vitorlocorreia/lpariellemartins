...
export default function Footer() {
  ...
  return (
    <footer
      ref={footerRef}
      id="contato"
      className="bg-[#111C40] text-blue-100/80 text-xs relative overflow-hidden border-t border-blue-900/60 transition-all duration-700"
      style={{
        opacity: visible ? 1 : 0,
    ...
    >
      ...
      <AmbientWaves className="w-full -mt-12 mb-4 opacity-40" color="#EAB308" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12 pt-8 pb-10 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 pb-10 border-b border-blue-900/50 items-start">
          ...
          <div className="md:col-span-5 space-y-4">
            ...
            <p className="text-xs text-blue-200/80 max-w-xs leading-relaxed">

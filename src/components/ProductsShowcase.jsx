...
export default function ProductsShowcase({ onOpenModal, whatsappUrl }) {
  ...
  return (
    <section ref={sectionRef} id="produtos" className="py-12 sm:py-16 lg:py-20 bg-[#F4F7FC] relative overflow-hidden">
      ...
      <BackgroundCircle size={360} color="#E0E7FF" opacity={0.4} className="-top-12 left-1/4 z-0" />
      <DottedPattern rows={5} cols={6} color="#2563EB" opacity={0.08} className="absolute top-6 right-6 z-0 hidden sm:block" />

      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        
        {/* Card Container */}
        <div className="ebook-anim-card bg-white rounded-3xl p-6 sm:p-8 lg:p-12 border border-blue-100/90 shadow-xl shadow-blue-950/5 relative overflow-hidden">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
            ...
            <div className="lg:col-span-5 flex flex-col items-center justify-center">
              <TiltCard className="relative w-56 sm:w-64 md:w-72 lg:w-full max-w-[320px] group cursor-pointer">
                <div 
                  ...
                  className="relative rounded-2xl overflow-hidden shadow-2xl shadow-slate-900/15 border border-slate-200/80 bg-white transition-all duration-300 group-hover:shadow-blue-500/15 group-hover:border-blue-200"
                >
                  <img
                  ...
                  />
                  <div className="absolute inset-0 bg-[#1B2B5E]/30 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center gap-1.5 text-white font-bold text-xs uppercase tracking-wider backdrop-blur-[2px]">
                    <Eye size={16} />
              ...
              <div className="mt-3 flex items-center gap-1.5 text-[11px] font-medium text-[#4B5E8A]">
            ...
            <div className="lg:col-span-7 flex flex-col justify-center text-left space-y-4">
              ...
              <h2 className="font-serif text-2xl sm:text-3xl lg:text-4xl text-[#1B2B5E] font-bold leading-tight">
                Manual Prático de Treinamento para Idosos
              </h2>

              <p className="text-[#2C3E6B] text-sm sm:text-base leading-relaxed">
              ...
              {/* Benefits Checklist */}
              <div className="space-y-2 py-2 border-y border-slate-100 text-xs sm:text-sm text-[#1B2B5E]">
              ...
              <div className="pt-2 flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
                <a
                  ...
                  className="flex-1 h-13 sm:h-14 flex items-center justify-center gap-2 bg-[#2563EB] hover:bg-[#1D4ED8] text-white font-bold px-6 rounded-2xl text-sm sm:text-[15px] shadow-lg shadow-blue-500/25 active:scale-[0.98] transition-all cursor-pointer"
                >
                  <Bell size={18} />
                ...
                <button
                  type="button"
                  onClick={onOpenModal}
                  className="sm:w-auto h-13 sm:h-14 flex items-center justify-center gap-2 border border-blue-200 text-[#1B2B5E] hover:bg-blue-50 hover:border-blue-300 px-6 rounded-2xl text-sm font-semibold transition-all bg-white active:scale-[0.98] cursor-pointer"
                >
